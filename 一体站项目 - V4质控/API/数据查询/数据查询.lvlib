...
<Library LVVersion="16008000">
	...
	<Item Name="subvi" Type="Folder">
		...
		<Item Name="SQL" Type="Folder">
			<Item Name="display table.vi" Type="VI" URL="../subvi/SQL/display table.vi"/>
			<Item Name="drop table.vi" Type="VI" URL="../subvi/SQL/drop table.vi"/>
			...
			<Item Name="数据库清空对话框.vi" Type="VI" URL="../subvi/数据库清空对话框.vi"/>
