...
<Library LVVersion="16008000">
	...
	<Property Name="NI.Lib.Version" Type="Str">2.15.0.0</Property>
	...
	<Item Name="控件" Type="Folder">
		...
		<Item Name="量程设置.ctl" Type="VI" URL="../控件/量程设置.ctl"/>
	...
	<Item Name="通讯" Type="Folder">
		...
		<Item Name="V2公式读写" Type="Folder">
			<Item Name="版本号读取.vi" Type="VI" URL="../通讯/V2参数API/版本号读取.vi"/>
			<Item Name="备用系数读取.vi" Type="VI" URL="../通讯/V2参数API/备用系数读取.vi"/>
			<Item Name="备用系数写入.vi" Type="VI" URL="../通讯/V2参数API/备用系数写入.vi"/>
			<Item Name="公式读取.vi" Type="VI" URL="../通讯/V2参数API/公式读取.vi"/>
			<Item Name="公式复合写入.vi" Type="VI" URL="../通讯/V2参数API/公式复合写入.vi"/>
			<Item Name="公式写入.vi" Type="VI" URL="../通讯/V2参数API/公式写入.vi"/>
			<Item Name="量程参数读取.vi" Type="VI" URL="../通讯/V2参数API/量程参数读取.vi"/>
			<Item Name="量程参数写入.vi" Type="VI" URL="../通讯/V2参数API/量程参数写入.vi"/>
		</Item>
		...
		<Item Name="流程写入" Type="Folder">
			<Item Name="单个流程校验.vi" Type="VI" URL="../通讯/流程写入/单个流程校验.vi"/>
			<Item Name="单个流程写入.vi" Type="VI" URL="../通讯/流程写入/单个流程写入.vi"/>
			<Item Name="流程复合写入.vi" Type="VI" URL="../通讯/流程写入/流程复合写入.vi"/>
			<Item Name="流程写入仪器.vi" Type="VI" URL="../通讯/流程写入/流程写入仪器.vi"/>
		</Item>
