...
<Library LVVersion="16008000">
	...
	<Item Name="Interface" Type="Folder">
		<Item Name="Access insert values.vi" Type="VI" URL="../Interface/Access insert values.vi"/>
	</Item>
	<Item Name="subvi" Type="Folder">
		<Item Name="Access DB Path.vi" Type="VI" URL="../subvi/Access DB Path.vi"/>
		<Item Name="Access Platform DB Path.vi" Type="VI" URL="../subvi/Access Platform DB Path.vi"/>
		<Item Name="alter database password.vi" Type="VI" URL="../subvi/alter database password.vi"/>
