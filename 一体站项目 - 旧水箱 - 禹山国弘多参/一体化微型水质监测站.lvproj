...
<Project Type="Project" LVVersion="16008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="斯坦道多参数.lvlib" Type="Library" URL="../API/斯坦道仪器多参数_禹山国弘组合版/斯坦道多参数.lvlib"/>
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="多参数24H周期设置.xctl" Type="XControl" URL="../API/斯坦道仪器多参数_禹山国弘组合版/控件/24H周期设置/多参数24H周期设置.xctl"/>
		</Item>
		<Item Name="程序生成规范" Type="Build">
			<Item Name="一体化微型水质监测站" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{CC5256DD-DF04-49B2-9BAD-C55D0E48D8F3}</Property>
