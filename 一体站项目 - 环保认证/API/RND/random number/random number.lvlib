...
<Library LVVersion="16008000">
	...
	<Item Name="绝对偏差百分比出数.vi" Type="VI" URL="../绝对偏差百分比出数.vi"/>
	<Item Name="相对偏差百分比出数.vi" Type="VI" URL="../相对偏差百分比出数.vi"/>
	<Item Name="自动采样.vi" Type="VI" URL="../自动采样.vi"/>
	<Item Name="随机数出数.vi" Type="VI" URL="../随机数出数.vi"/>
	<Item Name="定时控制.vi" Type="VI" URL="../定时控制.vi"/>
	<Item Name="反算.vi" Type="VI" URL="../反算.vi"/>
</Library>
