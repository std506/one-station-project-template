...
<Library LVVersion="16008000">
	...
	<Item Name="数据平滑.vi" Type="VI" URL="../数据平滑.vi"/>
	<Item Name="随机数出数.vi" Type="VI" URL="../随机数出数.vi"/>
	<Item Name="仿真全局变量.vi" Type="VI" URL="../仿真全局变量.vi"/>
	<Item Name="设置窗口.vi" Type="VI" URL="../设置窗口.vi"/>
	<Item Name="后台服务.vi" Type="VI" URL="../后台服务.vi"/>
</Library>
