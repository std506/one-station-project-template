...
<Project Type="Project" LVVersion="16008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="斯坦道多参数.lvlib" Type="Library" URL="../API/斯坦道多参数/斯坦道多参数.lvlib"/>
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="多参数24H周期设置.xctl" Type="XControl" URL="../API/斯坦道多参数/控件/24H周期设置/多参数24H周期设置.xctl"/>
		</Item>
		<Item Name="程序生成规范" Type="Build">
			<Item Name="一体化微型水质监测站" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{CAB71DC3-3042-4DAA-9191-67A33B266516}</Property>
