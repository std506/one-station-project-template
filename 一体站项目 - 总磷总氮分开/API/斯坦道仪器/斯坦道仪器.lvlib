...
<Library LVVersion="16008000">
	...
	<Item Name="常规五参数" Type="Folder">
		...
		<Item Name="校准" Type="Folder">
			<Item Name="多参校准.vi" Type="VI" URL="../常规五参数/校准/多参校准.vi"/>
			<Item Name="多参校准第一步.vi" Type="VI" URL="../常规五参数/校准/多参校准第一步.vi"/>
			<Item Name="多参校准第二步.vi" Type="VI" URL="../常规五参数/校准/多参校准第二步.vi"/>
	...
	<Item Name="总磷氨氮" Type="Folder">
		<Property Name="NI.SortType" Type="Int">3</Property>
		<Item Name="UI" Type="Folder">
			<Item Name="运维调试_总磷.vi" Type="VI" URL="../总磷氨氮/UI/运维调试_总磷.vi"/>
		</Item>
		<Item Name="变量" Type="Folder">
