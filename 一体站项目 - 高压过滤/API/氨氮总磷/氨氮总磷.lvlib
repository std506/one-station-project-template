...
<Library LVVersion="16008000">
	...
	<Item Name="Control" Type="Folder">
		<Item Name="总磷氨氮测量数据" Type="Folder">
			<Item Name="氨氮测量数据.xctl" Type="XControl" URL="../Control/总磷氨氮测量数据/氨氮测量数据.xctl"/>
		</Item>
		<Item Name="总磷氨氮调试" Type="Folder">
			<Item Name="subvi" Type="Folder">
				<Item Name="氨氮调试.xctl" Type="XControl" URL="../Control/总磷氨氮调试/氨氮调试.xctl"/>
			</Item>
		</Item>
		<Item Name="总磷氨氮运行状态" Type="Folder">
			<Item Name="氨氮运行状态.xctl" Type="XControl" URL="../Control/总磷氨氮运行状态/氨氮运行状态.xctl"/>
		</Item>
	</Item>
	...
	<Item Name="总磷氨氮" Type="Folder">
		...
		<Item Name="UI" Type="Folder">
			<Item Name="运维调试_氨氮总磷.vi" Type="VI" URL="../总磷氨氮/UI/运维调试_氨氮总磷.vi"/>
		</Item>
