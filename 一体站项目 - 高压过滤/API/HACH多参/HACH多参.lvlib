...
<Library LVVersion="16008000">
	...
	<Item Name="HACH全局.vi" Type="VI" URL="../HACH全局.vi"/>
	<Item Name="多参水样测试.vi" Type="VI" URL="../多参水样测试.vi"/>
	<Item Name="写入数据库.vi" Type="VI" URL="../写入数据库.vi"/>
	<Item Name="运维调试_HACH多参.vi" Type="VI" URL="../运维调试_HACH多参.vi"/>
</Library>
