...
<Library LVVersion="16008000">
	...
	<Item Name="Subvi" Type="Folder">
		...
		<Item Name="氨氮质控参数设置.vi" Type="VI" URL="../main/氨氮质控参数设置.vi"/>
	...
	<Item Name="通讯" Type="Folder">
		<Item Name="参数读取写入" Type="Folder">
			...
			<Item Name="备用系数读取.vi" Type="VI" URL="../main/COM/备用系数读取.vi"/>
			<Item Name="备用系数写入.vi" Type="VI" URL="../main/COM/备用系数写入.vi"/>
			...
			<Item Name="量程参数复合参数写入.vi" Type="VI" URL="../main/COM/量程参数复合参数写入.vi"/>
		...
		<Item Name="通讯.vi" Type="VI" URL="../main/通讯.vi"/>
